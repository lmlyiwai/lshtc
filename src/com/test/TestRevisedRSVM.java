...
public class TestRevisedRSVM {
	...
	public void test() throws IOException, InvalidInputDataException {
		...
		RevisedRSVM rrs = new RevisedRSVM(tree, prob, param, 0.001, 0);
		
		
		Problem testprob0 = FileIO.readProblem(new File(testfile0), 1);
		testprob0.getFileLabels(iamap);
		testprob0.y = FileInputOutput.transLabels(testprob0.y, tree, tree.getInnerToAdd());
...
//		testprob.y = FileInputOutput.transLabels(testprob.y, tree, tree.getInnerToAdd());
		...
		rrs.train(prob, testprob0, param);
